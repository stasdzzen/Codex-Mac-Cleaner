...
> [!WARNING]
> `v0.1.0-beta.3` — публичная тестовая версия для проверки на синтетических
...
`v0.1.0-beta.3` включает живой Audit Dashboard с пофазным прогрессом,
...
См. [заметки к v0.1.0-beta.3](docs/release/v0.1.0-beta.3.md).
