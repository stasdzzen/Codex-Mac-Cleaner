...
> [!WARNING]
> `v0.1.0-beta.5` — публичная тестовая версия. Автоматические проверки прошли
...
### Обновление с beta.4 до beta.5

Beta.4 уже содержит безопасный навык обновления. Удалять marketplace или
...
старый marketplace snapshot, затем повторно установите пакет из beta.5:
...
Beta.5 сохраняет отдельный безопасный навык обновления. После публикации
...
`v0.1.0-beta.5` исправляет упаковку визуального Audit Dashboard, добавляет
совместимый app-surface контракт Codex и сохраняет безопасное обновление по
точному тегу, живой пофазный прогресс,
ограниченный общий сбор macOS inventories, пятиминутный server deadline,
runtime-пакеты, автоматические security/privacy/contract gates и deterministic
package evidence. Beta не
...
См. [заметки к v0.1.0-beta.5](docs/release/v0.1.0-beta.5.md).
