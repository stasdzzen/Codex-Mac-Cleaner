...
> [!WARNING]
> `v0.1.0-beta.7` — тестовая версия. Автоматические проверки проходят в
...
Удалять установленный плагин вручную не нужно. В новой задаче выберите Codex
Mac Cleaner и укажите точную опубликованную версию, например:
...
Текущие заметки: [v0.1.0-beta.7](docs/release/v0.1.0-beta.7.md). Ручная
