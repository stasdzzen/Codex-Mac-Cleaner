...
> [!WARNING]
> `v0.1.0-beta.11` — тестовая версия. Автоматические проверки проходят в
...
установлена `v0.1.0-beta.10`, создайте новую задачу, выберите Codex Mac Cleaner
и напишите:
...
Текущие заметки: [v0.1.0-beta.11](docs/release/v0.1.0-beta.11.md). Ручная
