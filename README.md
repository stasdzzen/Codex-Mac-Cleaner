...
> [!WARNING]
> `v0.1.0-beta.2` — публичная тестовая версия для проверки на синтетических
...
версию автоматически. Удалите старую установку и source, затем добавьте beta.2:
...
`v0.1.0-beta.2` включает runtime-пакеты, Audit Dashboard, автоматические
...
См. [заметки к v0.1.0-beta.2](docs/release/v0.1.0-beta.2.md).
