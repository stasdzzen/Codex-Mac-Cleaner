...
> [!WARNING]
> `v0.1.0-beta.9` — тестовая версия. Автоматические проверки проходят в
...
установлена `v0.1.0-beta.8`, создайте новую задачу, выберите Codex Mac Cleaner
и напишите:
...
Текущие заметки: [v0.1.0-beta.9](docs/release/v0.1.0-beta.9.md). Ручная
