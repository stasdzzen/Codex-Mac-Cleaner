...
| Codex и Skill | Ведут диалог и вызывают model-visible tools | Недоверенный инициатор структурированных запросов |
...
| Локальное хранилище | Хранит отчёты, манифесты, журнал и payload | Доверенная область только после проверки прав и пути |
