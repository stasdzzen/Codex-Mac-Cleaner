...
Публичные safety-уточнения распределяются внутри существующих пакетов CMC-03/04/05/07/08/09/10. Persistent exclusions и schedule получают отдельные CMC-12/13. ADR-0012 и базовый correlation contract оформляет CMC-20; ADR-0013/actionability delta — CMC-22; core resolver продолжает существующая CMC-21 только после merge CMC-22. После merge CMC-21 возобновляется существующий CMC-09 PR #34. Advanced Cleanup и Browser/Developer Storage фиксируются blocked research Issues CMC-14/15 и не входят в v0.1.
