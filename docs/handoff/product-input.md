...
3. Server-owned correlation resolver, completeness certificates, evidence normalization, classifier и deterministic fixtures.
...
Публичные safety-уточнения распределяются внутри существующих пакетов CMC-03/04/05/07/08/09/10. Persistent exclusions и schedule получают отдельные CMC-12/13. ADR-0012 и correlation contract оформляет CMC-20, core resolver — отдельная CMC-21; только после её merge возобновляется существующий CMC-09 PR #34. Advanced Cleanup и Browser/Developer Storage фиксируются blocked research Issues CMC-14/15 и не входят в v0.1.
