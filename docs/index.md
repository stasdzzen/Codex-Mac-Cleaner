...
Архитектурный пакет утверждён 15 июля 2026 года и дополнен ADR-0009, ADR-0010 и ADR-0011 от 17 июля 2026 года. ADR-0011 заменяет персональные protected-правила универсальными классами публичного продукта и добавляет persistent exclusions и capability-aware Codex-расписание. Product-документы, планы, промпты и GitHub Issues являются производными артефактами и не могут менять архитектурный канон.
