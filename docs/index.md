...
Архитектурный пакет утверждён 15 июля 2026 года и дополнен ADR-0009 и ADR-0010 от 17 июля 2026 года. ADR-0010 переносит полевое исследование в server-side protected scopes, безопасные метаданные, inspection-only находки и наблюдаемые метрики диска. Product-документы, планы, промпты и GitHub Issues являются производными артефактами и не могут менять архитектурный канон.
