...
* **Выпуск**: CMC-50 опубликовал `v0.1.0-beta.12` из merge SHA `afe603dd9e26bca221ea6496a8f2e51ea40f7a4b`; probe вошёл в release gates, а real-Mac smoke остался отдельным действием владельца.
