...
| `CMC-21` | [#36 — core correlation/evidence resolver](https://github.com/stasdzzen/Codex-Mac-Cleaner/issues/36) | `cto:blocked` до merge #39; сохранить существующий PR #38 |
| `CMC-22` | [#39 — actionable Library remnants](https://github.com/stasdzzen/Codex-Mac-Cleaner/issues/39) | `cto:in-progress`; текущая docs-first архитектурная задача |
