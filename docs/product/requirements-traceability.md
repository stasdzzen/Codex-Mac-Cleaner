...
| `REQ-MCP-PROBE-01` | Packaged stdio surface проверяется по точным tools, visibility metadata и Dashboard URI/MIME/CSP; drift блокирует release gate | [Capability matrix](../quality/plugin-capability-matrix.md), [Runbook](../development/audit-runtime-troubleshooting.md) | `CMC-49` | H |
| `REQ-MCP-PAGE-01` | Полная revision выдаётся bounded страницами до 100 findings и 512 КиБ; model/widget cursors независимы, следующая UI-страница только по нажатию | [ADR-0020](../decisions/ADR-0020-bounded-dashboard-pagination.md), [MCP contract](../contracts/mcp-tools.md) | `CMC-47` | G, H |
...
| `REQ-UI-01` | Тёмный shadcn Dashboard v4 на Base UI с четырьмя вкладками и grouped-таблицей на «Обзоре»; «Автопроверка» в v0.1 только для ручного запуска | [ADR-0006](../decisions/ADR-0006-dark-shadcn-dashboard.md), [ADR-0021](../decisions/ADR-0021-persistent-grouped-dashboard-v4.md) | `CMC-08`, `CMC-09`, `CMC-12`, `CMC-10`, `CMC-38`, `CMC-40`, `CMC-53` | G |
| `REQ-UI-LIVE-01` | Dashboard v4 открывается сразу, показывает server-owned phase/counts, а последняя completed revision безопасно открывается после restart | [ADR-0015](../decisions/ADR-0015-live-audit-dashboard-and-shared-inventories.md), [ADR-0020](../decisions/ADR-0020-bounded-dashboard-pagination.md), [ADR-0021](../decisions/ADR-0021-persistent-grouped-dashboard-v4.md) | `CMC-26`, `CMC-47`, `CMC-53` | G, H |
| `REQ-UI-DISPLAY-01` | Dashboard остаётся inline по умолчанию; кнопка переключается между «Развернуть»/«Свернуть», завершение не меняет режим, PiP отсутствует | [ADR-0016](../decisions/ADR-0016-fullscreen-only-dashboard-display.md), [ADR-0021](../decisions/ADR-0021-persistent-grouped-dashboard-v4.md) | `CMC-32`, `CMC-35`, `CMC-53` | G, H |
| `REQ-AUDIT-PERSIST-01` | Последняя completed revision хранится атомарно с HMAC/0600, не содержит reusable authority и открывается через `null/null` | [ADR-0021](../decisions/ADR-0021-persistent-grouped-dashboard-v4.md) | `CMC-53` | D, G, H |
| `REQ-QUAR-SEQ-01` | Полная очистка карантина — только последовательность поэлементных preview/confirm/purge без bulk token | [ADR-0021](../decisions/ADR-0021-persistent-grouped-dashboard-v4.md) | `CMC-53` | E, G, H |
...
| `REQ-DIST-01` | GitHub Releases и repository marketplace | [ADR-0007](../decisions/ADR-0007-github-distribution.md) | `CMC-09`, `CMC-10`, `CMC-37`, `CMC-39`, `CMC-41`, `CMC-45` | H |
...
| `CMC-48` | [#90 — выпуск v0.1.0-beta.11](https://github.com/stasdzzen/Codex-Mac-Cleaner/issues/90) | Закрыта; PR #93 слит, выпуск опубликован |
| `CMC-49` | [#94 — диагностика beta.11 и проверка поверхности плагина](https://github.com/stasdzzen/Codex-Mac-Cleaner/issues/94) | Закрыта; PR #95 слит |
| `CMC-50` | [#96 — выпуск v0.1.0-beta.12](https://github.com/stasdzzen/Codex-Mac-Cleaner/issues/96) | Закрыта; PR #97 слит, [выпуск опубликован](https://github.com/stasdzzen/Codex-Mac-Cleaner/releases/tag/v0.1.0-beta.12) |
| `CMC-51` | [#98 — синхронизация статуса выпуска beta.12](https://github.com/stasdzzen/Codex-Mac-Cleaner/issues/98) | Закрыта; PR #99 слит |
| `CMC-52` | [#100 — публичная гигиена и первый экран README](https://github.com/stasdzzen/Codex-Mac-Cleaner/issues/100) | В работе |
| `CMC-53` | [#102 — упростить Dashboard и сохранять последний аудит](https://github.com/stasdzzen/Codex-Mac-Cleaner/issues/102) | В работе |
