...
Сначала прочитай AGENTS.md, docs/development/execution-contract.md, docs/development/public-repository-policy.md, docs/safety/safety-model.md и live Issue. Сопоставь GitHub settings с публичным Codex-Skills, но не копируй его Python/package/release gates: этот репозиторий пока docs-first.
