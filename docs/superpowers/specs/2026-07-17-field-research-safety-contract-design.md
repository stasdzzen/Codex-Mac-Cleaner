...
Первоначальный session-local no-op заменён ADR-0011. Канонические действия публичного продукта — «Удалить» с quarantine одного объекта, persistent «Исключить» и session-local «Пропустить сейчас». Окончательное удаление остаётся отдельным действием только во вкладке «Карантин» после нового preview.
...
4. Все решения принимаются кнопками «Удалить», «Исключить», «Пропустить сейчас», «Восстановить» и «Удалить навсегда».
...
| `CMC-08` | «Удалить»/«Пропустить сейчас», `supportLevel`, `unsupported_manual`, пять независимых показателей и отсутствие shell UX |
